        ...
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                ...
                <div class="bg-white rounded-2xl shadow-sm border border-gray-200 p-6">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-3xl font-bold text-gray-900 mt-2"><?php echo e($stats['guias']); ?></p>
                        </div>
                ...
                <div class="bg-white rounded-2xl shadow-sm border border-gray-200 p-6">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-3xl font-bold text-gray-900 mt-2"><?php echo e($stats['faq']); ?></p>
                        </div>
                ...
                <div class="bg-white rounded-2xl shadow-sm border border-gray-200 p-6">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-3xl font-bold text-gray-900 mt-2"><?php echo e(number_format($stats['total_views'])); ?></p>
                        </div>
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-200 p-6">
                <div class="flex justify-between items-start mb-6">
                    ...
                    <a href="<?php echo e(route('admin.knowledge-base.create')); ?>" 
                                ...
                                <div class="group border border-gray-200 rounded-xl p-5 hover:shadow-md hover:border-yellow-300 transition-all duration-200">
                                    <div class="flex items-start justify-between mb-3">
                                        ...
                                        <div class="flex items-center gap-1">
                                            ...
                                            <form action="<?php echo e(route('admin.knowledge-base.destroy', $article->id)); ?>" method="POST" class="inline"
                                    ...
                                    <a href="<?php echo e(route('admin.knowledge-base.show', $article->id)); ?>" class="block">
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\MesaISTM\MesaITSM\resources\views/admin/knowledge-base/index.blade.php ENDPATH**/ ?>
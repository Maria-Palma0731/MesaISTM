        ...
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
            ...
            <div class="mt-8">
                ...
                <div class="grid grid-cols-1 gap-4 md:grid-cols-3">
                    <!-- Gestión de Tickets -->
                    <a href="<?php echo e(route('tecnico.tickets.index')); ?>" class="block p-6 transition bg-white rounded-lg shadow hover:shadow-md">
                    ...
                    <a href="<?php echo e(route('knowledge-base.index')); ?>" class="block p-6 transition bg-white rounded-lg shadow hover:shadow-md">
                        <div class="flex items-start">
                    ...
                    <a href="<?php echo e(route('catalog.index')); ?>" class="block p-6 transition bg-white rounded-lg shadow hover:shadow-md">
                        <div class="flex items-start">

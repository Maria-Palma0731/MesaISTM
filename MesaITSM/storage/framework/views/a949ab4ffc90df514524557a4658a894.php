            ...
            <div class="grid grid-cols-1 gap-6 lg:grid-cols-2">
                            ...
                            <div class="flex items-start space-x-4 p-4 rounded-xl hover:bg-gray-50 transition-colors">
                                ...
                                <div class="flex-1 min-w-0">
                                    <div class="flex items-center justify-between mb-1">
                                        <p class="text-sm font-medium text-gray-900"><?php echo e($ticket->folio); ?></p>
                                    ...
                                    <p class="text-sm text-gray-900 truncate"><?php echo e($ticket->title); ?></p>
                                    <div class="flex items-center mt-2 space-x-2">
                                        <span class="px-2 py-0.5 text-xs font-medium rounded-md bg-cyan-100 text-cyan-700">
                                            <?php echo e(ucfirst($ticket->status)); ?>

                                        </span>
                                        <span class="text-xs text-gray-500">Hace <?php echo e($ticket->created_at->diffForHumans()); ?></span>
                                    </div>
                                </div>
                            </div>
                        </a>
                ...
                <div class="bg-white rounded-2xl shadow-sm border border-gray-200 p-6">
                    ...
                    <div class="space-y-3">
                        ...
                        <a href="#" class="flex items-center justify-between p-4 rounded-xl hover:bg-purple-50 transition-colors group">
                            <div class="flex items-center space-x-4">
...
<?php endif; ?><?php /**PATH C:\laragon\www\Proyecto-mesa\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>
    ...
    <div class="py-6">
        <div class="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
            ...
            <div class="bg-white shadow-sm border border-gray-200 rounded-2xl overflow-hidden">
                <div class="p-8">
                    <form action="<?php echo e(route('administrador.users.store')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>">
                                    ...
                                    <option value="usuario" <?php echo e(old('role') === 'usuario' ? 'selected' : ''); ?>>Usuario</option>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <select name="is_active" id="is_active" 
                                    ...
                                    <option value="1" <?php echo e(old('is_active', 1) == 1 ? 'selected' : ''); ?>>Activo</option>
                                    <option value="0" <?php echo e(old('is_active', 1) == 0 ? 'selected' : ''); ?>>Inactivo</option>
                                </select>
                            </div>
                        </div>
...
<?php endif; ?><?php /**PATH C:\laragon\www\Proyecto-mesa\resources\views/admin/users/create.blade.php ENDPATH**/ ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <?php if(auth()->user()->role === 'administrador' && !empty($tecnicos)): ?>
                    <div>
                        ...
                        <select name="assigned_to" id="assigned_to"
                            ...
                            <?php $__currentLoopData = $tecnicos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tecnico): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($tecnico->id); ?>" <?php echo e(old('assigned_to') == $tecnico->id ? 'selected' : ''); ?>>
                                    <?php echo e($tecnico->name); ?> (<?php echo e($tecnico->department); ?>)
                                </option>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="flex justify-end space-x-3">
                        <a href="<?php echo e(auth()->user()->role === 'administrador' ? route('administrador.tickets.index') : route(auth()->user()->role . '.dashboard')); ?>"
...
<?php endif; ?><?php /**PATH C:\laragon\www\MesaISTM\MesaITSM\resources\views/tickets/create.blade.php ENDPATH**/ ?>
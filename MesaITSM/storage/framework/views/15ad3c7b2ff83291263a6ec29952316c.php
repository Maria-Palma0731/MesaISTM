        ...
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
            ...
            <div class="mb-6 sm:flex sm:items-center sm:justify-between">
                <div class="flex space-x-3">
                    <a href="<?php echo e(route('tecnico.tickets.index')); ?>" class="text-indigo-600 hover:text-indigo-900">
                ...
                <div class="mt-3 flex sm:mt-0 sm:ml-4">
                    ...
                    <?php if($ticket->status === 'en_proceso'): ?>
                        <button type="button"
            ...
            <div class="grid grid-cols-1 gap-6 lg:grid-cols-2">
                ...
                <div class="space-y-6">
                        ...
                        <div class="px-4 py-5 sm:p-6">
                            <div class="flex items-center justify-between">
                                ...
                                <div class="flex space-x-3">
                                    <span class="inline-flex items-center rounded-full px-2.5 py-0.5 text-xs font-medium
                                        <?php echo e($ticket->getPriorityColorClass()); ?>">
                                        <?php echo e(ucfirst($ticket->priority)); ?>

                                    </span>
                                    <span class="inline-flex items-center rounded-full px-2.5 py-0.5 text-xs font-medium
                                        <?php echo e($ticket->getStatusColorClass()); ?>">
                            ...
                            <div class="mt-4 space-y-3 text-sm text-gray-600">
                                ...
                                <div>
                                    ...
                                    <?php echo e($ticket->getTotalTimeLogged()); ?> minutos
                                </div>
                            </div>
                    ...
                    <?php if(in_array($ticket->status, ['asignado', 'en_proceso', 'pendiente_usuario'])): ?>
                        <div class="overflow-hidden bg-white shadow sm:rounded-lg">
                            <div class="px-4 py-5 sm:p-6">
                                <h3 class="mb-4 text-lg font-medium">Actualizar estado</h3>
                                
                                <form action="<?php echo e(route('tecnico.tickets.update-status', $ticket)); ?>" method="POST" class="space-y-4">
                                    <?php echo csrf_field(); ?>
                ...
                <div class="space-y-6">
                    ...
                    <div class="overflow-hidden bg-white shadow sm:rounded-lg">
                        <div class="px-4 py-5 sm:p-6">
                            ...
                            <?php if (isset($component)) { $__componentOriginalb1c9528b82d47b4a36f9731798c84e6e = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalb1c9528b82d47b4a36f9731798c84e6e = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.ticket-comments','data' => ['comments' => $ticket->comments]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('ticket-comments'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['comments' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($ticket->comments)]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalb1c9528b82d47b4a36f9731798c84e6e)): ?>
<?php $attributes = $__attributesOriginalb1c9528b82d47b4a36f9731798c84e6e; ?>
<?php unset($__attributesOriginalb1c9528b82d47b4a36f9731798c84e6e); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalb1c9528b82d47b4a36f9731798c84e6e)): ?>
<?php $component = $__componentOriginalb1c9528b82d47b4a36f9731798c84e6e; ?>
<?php unset($__componentOriginalb1c9528b82d47b4a36f9731798c84e6e); ?>
<?php endif; ?>

                            <!-- Formulario de comentario -->
                            <div class="mt-6 border-t pt-6">
                                <form action="<?php echo e(route('tecnico.tickets.comment', $ticket)); ?>" method="POST" enctype="multipart/form-data">
                                    <?php echo csrf_field(); ?>
            ...
            <div class="relative inline-block transform overflow-hidden rounded-lg bg-white px-4 pt-5 pb-4 text-left align-bottom shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg sm:p-6 sm:align-middle">
                ...
                <div class="sm:flex sm:items-start">
                    <div class="mt-3 w-full text-center sm:mt-0 sm:text-left">
                        ...
                        <form action="<?php echo e(route('tecnico.tickets.escalate', $ticket)); ?>" method="POST" class="mt-4">
                            <?php echo csrf_field(); ?>
            ...
            <div class="relative inline-block transform overflow-hidden rounded-lg bg-white px-4 pt-5 pb-4 text-left align-bottom shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg sm:p-6 sm:align-middle">
                ...
                <div class="sm:flex sm:items-start">
                    <div class="mt-3 w-full text-center sm:mt-0 sm:text-left">
                        ...
                        <form action="<?php echo e(route('tecnico.tickets.resolve', $ticket)); ?>" method="POST" class="mt-4">
                            <?php echo csrf_field(); ?>
...
<?php endif; ?><?php /**PATH C:\laragon\www\MesaISTM\MesaITSM\resources\views/tecnico/tickets/show.blade.php ENDPATH**/ ?>
        ...
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 gap-6 mb-8 sm:grid-cols-3">
                <div class="bg-white rounded-2xl shadow-sm border border-gray-200 p-6">
                    ...
                    <div class="text-4xl font-bold text-gray-900">{{ $totalTickets }}</div>
                </div>

                <div class="bg-white rounded-2xl shadow-sm border border-gray-200 p-6">
                    <div class="text-sm font-medium text-gray-600 mb-2">Tickets Activos</div>
                    <div class="text-4xl font-bold text-yellow-600">{{ $activeTickets }}</div>
                </div>

                <div class="bg-white rounded-2xl shadow-sm border border-gray-200 p-6">
                    <div class="text-sm font-medium text-gray-600 mb-2">Tickets Resueltos</div>
                    <div class="text-4xl font-bold text-green-600">{{ $resolvedTickets }}</div>
                </div>
            </div>
                ...
                <div class="bg-white rounded-2xl shadow-sm border border-gray-200 p-6">
                    ...
                    <div class="space-y-3 mb-4">
                        <div class="flex items-center justify-between p-3 bg-blue-50 rounded-lg">
                            ...
                            <span class="text-2xl font-bold text-blue-600">{{ $openTickets }}</span>
                        </div>
                        <div class="flex items-center justify-between p-3 bg-cyan-50 rounded-lg">
                            ...
                            <span class="text-2xl font-bold text-cyan-600">{{ $inProgressTickets }}</span>
                        </div>
                        <div class="flex items-center justify-between p-3 bg-green-50 rounded-lg">
                            <span class="text-sm font-medium text-green-900">Resueltos</span>
                            <span class="text-2xl font-bold text-green-600">{{ $resolvedTickets }}</span>
                        </div>
                    </div>
                        ...
                        <div class="flex items-center justify-between p-4 rounded-xl hover:bg-gray-50 transition-colors border border-gray-200">
                            <div class="flex-1">
                                <div class="flex items-center gap-3 mb-2">
                                    <span class="text-sm font-medium text-gray-500">{{ $ticket->folio }}</span>
                                    <span class="px-2 py-0.5 text-xs font-medium rounded-full 
                                        @switch($ticket->priority)
                                            @case('baja') bg-green-100 text-green-700 @break
                                            @case('media') bg-yellow-100 text-yellow-700 @break
                                            @case('alta') bg-orange-100 text-orange-700 @break
                                            @case('critica') bg-red-100 text-red-700 @break
                                        @endswitch">
                                ...
                                <div class="flex items-center gap-3 mt-2">
                                    <span class="px-2 py-0.5 text-xs font-medium rounded-md
                                        @switch($ticket->status)
                                            @case('nuevo') bg-blue-100 text-blue-700 @break
                                            @case('asignado') bg-purple-100 text-purple-700 @break
                                            @case('en_proceso') bg-cyan-100 text-cyan-700 @break
                                            @case('pendiente_usuario') bg-orange-100 text-orange-700 @break
                                            @case('resuelto') bg-green-100 text-green-700 @break
                                            @case('cerrado') bg-gray-100 text-gray-700 @break
                                        @endswitch">
        ...
        <div class="flex items-center justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:block sm:p-0">
            ...
            <div class="inline-block overflow-hidden text-left align-middle transition-all transform bg-white rounded-2xl shadow-xl sm:my-8 sm:align-middle sm:max-w-2xl sm:w-full">
                <div class="px-8 pt-6 pb-6 bg-white">
                    ...
                    <form id="createTicketForm" method="POST" action="{{ route('tickets.store') }}" enctype="multipart/form-data">
                        @csrf

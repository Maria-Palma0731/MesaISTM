    ...
    <div class="py-12">
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
            ...
            <div class="p-4 mb-8 bg-white rounded-lg shadow">
                <form action="{{ route('tecnico.tickets.index') }}" method="GET" class="grid grid-cols-1 gap-4 md:grid-cols-5">
                    <div>
                    ...
                    <div class="flex items-end gap-2">
                        ...
                        <a href="{{ route('tecnico.tickets.index') }}" class="px-4 py-2 text-gray-700 bg-gray-100 rounded-md hover:bg-gray-200">
                            Limpiar
                        </a>
                    </div>
                </form>

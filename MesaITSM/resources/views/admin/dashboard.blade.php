    ...
    <div class="py-6">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 gap-6 mb-8 sm:grid-cols-2 lg:grid-cols-4">
                {{-- Tickets Abiertos --}}
                <div class="relative overflow-hidden bg-white rounded-2xl shadow-sm border border-gray-200 p-6 hover:shadow-md transition-shadow">
            ...
            <div class="grid grid-cols-1 gap-6 lg:grid-cols-2">
                ...
                <div class="bg-white rounded-2xl shadow-sm border border-gray-200 p-6">
                    <div class="mb-6">
                        <h2 class="text-lg font-semibold text-gray-900">Acceso Rápido</h2>
                    </div>
                    ...
                    <div class="space-y-3">
                        ...
                        <a href="{{ route('admin.reports.index') }}" class="flex items-center justify-between p-4 rounded-xl hover:bg-orange-50 transition-colors group">
                            <div class="flex items-center space-x-4">
